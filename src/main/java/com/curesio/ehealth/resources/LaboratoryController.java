...
public class LaboratoryController extends ExceptionHandlingController {

    private UserService userService;
    private ApplicationEventPublisher applicationEventPublisher;

    @Autowired
    public LaboratoryController(@Qualifier("userService") UserService userService, ApplicationEventPublisher applicationEventPublisher) {
    ...
    public ResponseEntity<HttpResponse> userSignUp(
            ...
            @RequestPart("laboratory_details") String laboratoryDetails,
        ...
        User user = userService.validateAndRegisterResource(userCredentials, userDetails, documentType, idFront, idBack, laboratoryDetails);
